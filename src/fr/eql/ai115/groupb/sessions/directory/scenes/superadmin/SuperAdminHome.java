...
import fr.eql.ai115.groupb.sessions.directory.components.menu.SuperAdminMenu;
...
public class SuperAdminHome {
    private static SuperAdminHome instance;
    private Scene scene;
    ...
    public SuperAdminHome(Stage primaryStage) throws IOException {

        // Appeler la méthode createUserMenu pour créer le menu administrateur
        SuperAdminMenu superAdminMenu = new SuperAdminMenu();
        MenuBar menubar = superAdminMenu.createSuperAdminMenu(primaryStage,this);
